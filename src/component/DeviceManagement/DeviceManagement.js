...
import Signinimg from "../../images/DeviceManagement/Account-is-not-paid..png"
        ...
        <div className="device_management">
            ...
            <Container>
                <Row>
                    ...
                    <Col xs="9" className="device_managemnt_box">
                    <div className="bg-white shadow p-3 mt-5 rounded1">
                        <h2 className="text-center">Device Managemnet</h2>
                        <img src={Signinimg} alt={Signinimg} className="w-25 mt-5" />
                        <h6>Account is not paid</h6>
                        </div>
                    </Col>
                </Row>
            </Container>
